...
class NavigationBar: UIView {
  ...
  func addCustomBottomLine(height: Double = 0.5) {
    
    let lineView = UIView(frame: CGRect(x: 0, y: 0, width:0, height: height))
    lineView.backgroundColor = theme.sideShadowColor
    ...
    lineView.topAnchor.constraint(equalTo: containerView.bottomAnchor).isActive = true
  }
