...
class ContactsGroupController: UIViewController {
...
extension ContactsGroupController: ProgressAlertControllerDelegate {
...
extension ContactsGroupController: SelectDropDownMenuDelegate {
  ...
  private func presentDropDonwMenu(with items: [MenuItem], from navigationButton: UIButton) {
    ...
    popoverPresentationController.sourceRect = CGRect(x: navigationButton.bounds.midX, y: navigationButton.bounds.maxY + 45, width: 0, height: 0)
...
extension ContactsGroupController: UIPopoverPresentationControllerDelegate {
...
extension ContactsGroupController: NavigationBarDelegate {
...
extension ContactsGroupController: ContactsGroupDataSourceDelegate {
