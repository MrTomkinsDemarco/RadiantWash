//
//  GroupedAssetListController.swift
//  RadiantWash
//
...
class GroupedAssetListController: UIViewController {
  ...
  override func viewDidAppear(_ animated: Bool) {
    ...
    updateCachedAssets()
    defaultContainerHeight = self.photoContentContainerView.frame.height
  ...
  private func presentDropDonwMenu(with items: [MenuItem], from navigationButton: UIButton) {
    let dropDownViewController = DropDownMenuController()
...
extension GroupedAssetListController: SelectDropDownMenuDelegate {
...
extension GroupedAssetListController: GroupSelectableAssetsDelegate {
...
extension GroupedAssetListController: NavigationBarDelegate {
...
extension GroupedAssetListController: BottomActionButtonDelegate {
...
extension GroupedAssetListController: UICollectionViewDelegate, UICollectionViewDataSource {
...
extension GroupedAssetListController: UIPopoverPresentationControllerDelegate {
...
extension GroupedAssetListController: UIScrollViewDelegate {
...
extension GroupedAssetListController: SNCollectionViewLayoutDelegate {
...
extension GroupedAssetListController: Themeble {
