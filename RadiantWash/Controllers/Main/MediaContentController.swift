...
class MediaContentController: UIViewController {
  ...
  private func showGropedContoller(grouped collection: [PhassetGroup], photoContent type: PhotoMediaType, media content: MediaContentType) {
    ...
    let viewController  = storyboard.instantiateViewController(withIdentifier: C.identifiers.viewControllers.groupedList) as! GroupedAssetListController
  ...
  private func showAssetViewController(collection: [PHAsset], photoContent type: PhotoMediaType, media content: MediaContentType) {
    let storyboard = UIStoryboard(name: C.identifiers.storyboards.media, bundle: nil)
    let viewController = storyboard.instantiateViewController(withIdentifier: C.identifiers.viewControllers.assetsList) as! AssetsListController
    viewController.title = type.mediaTypeName
  ...
  private func showGroupedContactsController(contacts group: [ContactsGroup], group type: ContactasCleaningType, content: PhotoMediaType) {
    let storyboard = UIStoryboard(name: C.identifiers.storyboards.contactsGroup, bundle: nil)
    let viewController = storyboard.instantiateViewController(withIdentifier: C.identifiers.viewControllers.contactsGroup) as! ContactsGroupController
  ...
  private func showCompressVideoPickerController(with videoPHAsset: [PHAsset]) {
    ...
    let storyboard = UIStoryboard(name: C.identifiers.storyboards.media, bundle: nil)
    let viewController = storyboard.instantiateViewController(withIdentifier: C.identifiers.viewControllers.videoCompressCollection) as! VideoCollectionCompressingController
    viewController.title = type.mediaTypeName
  ...
  private func showLocationController(with photoPHAssets: [PHAsset], annotationCollection: [MKAnnotation]) {
    ...
    let viewController = storyboard.instantiateViewController(withIdentifier: C.identifiers.viewControllers.location) as! LocationController
    viewController.title = type.mediaTypeName
...
extension MediaContentController: DateSelectebleViewDelegate {
...
extension MediaContentController: NavigationBarDelegate {
...
extension MediaContentController: UITableViewDelegate, UITableViewDataSource {
