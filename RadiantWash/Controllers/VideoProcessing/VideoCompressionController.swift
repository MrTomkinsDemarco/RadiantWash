//
//  VideoCompressionController.swift
//  RadiantWash
//
...
class VideoCompressionController: UIViewController {
  ...
  override func viewDidLoad() {
    ...
    setupVideoResolutionSlider()
    setupPfsSlider()
    handleAudioTrackIsEnable()
    setupVideoBitrateSlider()
    setupVideoKeyFrameSlider()
    setupAudioBitrateSlider()
    setupAudioSampleRateSlider()
  ...
  private func setupVideoResolutionSlider() {
  ...
  private func setupVideoBitrateSlider() {
  ...
  private func setupVideoKeyFrameSlider() {
  ...
  private func setupAudioBitrateSlider() {
  ...
  private func setupAudioSampleRateSlider() {
...
extension VideoCompressionController: UIGestureRecognizerDelegate {
...
extension VideoCompressionController: UIPopoverPresentationControllerDelegate {
