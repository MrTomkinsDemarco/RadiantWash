...
class CompressingDataSource: NSObject {
  
  public var compressionSettinsViewModel: CompressingViewModel
  ...
  init(compressionSettinsViewModel: CompressingViewModel) {
