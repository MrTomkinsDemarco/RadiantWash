//
//  LifeTimeSubscriptionController.swift
//  RadiantWash
//
...
class LifeTimeSubscriptionController: UIViewController {
...
extension LifeTimeSubscriptionController: UIGestureRecognizerDelegate {
