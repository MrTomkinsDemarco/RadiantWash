//
//  PremiumFeaturesSubscriptionCell.swift
//  RadiantWash
//
...
class PremiumFeaturesSubscriptionCell: UITableViewCell {
  ...
  public func setup(leadingFeatures: [PremiumFeature], trailingFeautures: [PremiumFeature]) {
    ...
    for feature in leadingFeatures {
      ...
      featureView.configureView(feature: feature, settingsSize: true)
  ...
  private func setupUI() {
    ...
    if let topRow = leadingTitle.first, let bottomRow = leadingTitle.last {
      ...
      setupCustomLabelText(topRow: topRow,
                         bottomRow: bottomRow,
  ...
  private func setupCustomLabelText(topRow: String, bottomRow: String, firstRowColors: [CGColor], secondRowColor: UIColor, label: UILabel, topFont: UIFont, bottomFont: UIFont) {
  ...
  private func setupBackgroundImage() {
    ...
    imageViewContainerView.setBorder(radius: 12, color: theme.bottomShadowColor.withAlphaComponent(0.15), width: 1)
