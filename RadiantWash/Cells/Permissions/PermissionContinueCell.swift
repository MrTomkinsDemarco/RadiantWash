...
class PermissionContinueCell: UITableViewCell {
  ...
  override func awakeFromNib() {
    ...
    setupContinueButton(availible: true)
  }
  
  public func setupContinueButton(availible: Bool) {
...
extension PermissionContinueCell: Themeble {
...
extension PermissionContinueCell: BottomActionButtonDelegate {
