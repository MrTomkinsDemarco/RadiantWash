...
class PermissionCell: UITableViewCell {
  ...
  public func setup(permission: Permission) {
    
    setupUI()
    setupAppearance()
    
    self.permission = permission
    self.setupButtonState(permission: permission)
  ...
  public func setupButtonState(permission: Permission) {
...
extension PermissionCell: Themeble {
