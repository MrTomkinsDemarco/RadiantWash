...
class VideoPreviewCell: UITableViewCell {
  ...
  public func setupPreview(from phasset: PHAsset, imageManager: PHCachingImageManager, size: CGSize) {
...
extension VideoPreviewCell: SliderViewDelegate {
...
extension VideoPreviewCell: Themeble {
