...
class DropDownMenuCell: UITableViewCell {
  ...
  public func setup(with menuItem: MenuItem, row position: RowPosition) {
    
    switch menuItem.type {
    case .sortByDate, .sortBySize, .sortByDimension, .sortByEdit, .duration:
      self.setupCheckmark(visible: menuItem.isChecked)
    default:
  ...
  public func setupCheckmark(visible: Bool) {
...
extension DropDownMenuCell: Themeble {
